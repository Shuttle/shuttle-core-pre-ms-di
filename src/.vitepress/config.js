...
module.exports = (async () => {
    ...
    return {
        ...
        base: '/shuttle-core-pre-ms-di/',
        lang: 'en-US',
        title: 'Shuttle.Core',
        description: 'Shuttle-Core Documentation (pre ms-di)',

        head: [
            ...base.head,
            ['link', { rel: "shortcut icon", href: "/shuttle-core-pre-ms-di/favicon.ico" }]
        ],

        themeConfig: {
            socialLinks: [
                { icon: 'github', link: 'https://github.com/Shuttle/shuttle-core-pre-ms-di' },
                // { icon: 'twitter', link: '' },
                // { icon: 'discord', link: '' }
            ],

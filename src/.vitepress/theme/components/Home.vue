...
<template>
    <section id="hero">
        <p class="documentation-redirect">
            This documentation relates to Shuttle.Core before the Microsoft Dependency Injection / Options changes were released.  You may wish to view the <a href="https://shuttle.github.io/shuttle-core/">latest documentation</a>.
        </p>

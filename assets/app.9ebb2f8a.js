...
function pathToFile(path) {
  ...
  {
    if (inBrowser$1) {
      const base = "/shuttle-core-pre-ms-di/";
...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  setup(__props) {
    const { theme } = useData();
    const VPAlgoliaSearchBox = defineAsyncComponent(() => import("./chunks/VPAlgoliaSearchBox.747be1f1.js"));
    const loaded = ref(false);
    const metaKey = ref();
    onMounted(() => {
